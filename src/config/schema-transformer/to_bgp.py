    ...
    def locate_routing_instance(self, rinst_name, service_chain=None):
        ...
        if old_rtgt:
            ...
            try:
                ...
                _sandesh._logger.error(
                    "NoIdError while deleting route target for routing instance {}".format(rinst_fq_name_str))
            except RefsExistError:
                _sandesh._logger.error(
                    "Back referenes exists while deleting route target for routing instance {}".format(rinst_fq_name_str))
